...
// used after the methods return.  However, the Context should
// only be used for actions related to the method call is was
// passed via.
//
// For example, for in a call to Key, only actions directly
// resulting from the key (e.g.  autocompletion or syntax
// highlighting) should have access to that Context. Actions that
// result from a call to Mouse in the future should not have access
// to this Context.
//
...
// is to be used after the method it was passed via returns, then
