...
//
// When a Context is passed to a Window via its methods, some of the methods of
// the previous Context that was passed will no longer work. This includes Buffer
// and Render.
//
...
type Context interface {
	...
	// this, and instead should be run when the Close method of the Window is
	// called.
	Quit()

	// Command sends an arbituary command to the caller. This is often used more for
	// any custom Window proxies, for example to broadcast a command to other Windows.
	Command(*Command)
